...
parser.add_argument 9'object', type=str, help= "Please enter the name that we are searching for."
...
arguments to the parse_args function.
#The returned object is an object with those command line arguments as
